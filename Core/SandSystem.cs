...
namespace Halo
{
    public class SandSystem : IDisposable
    {
        public ActorSystem ActorSystem { get; } = ActorSystem.Create(nameof(SandSystem),
