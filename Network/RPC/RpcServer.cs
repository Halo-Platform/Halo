...
namespace Halo.Network.RPC
{
    public sealed class RpcServer : IDisposable
    {
        ...
        public RpcServer(SandSystem system, Wallet wallet = null, Fixed8 maxGasInvoke = default(Fixed8), int maxConcurrentConnections = Peer.DefaultMaxConnections)
        {
            this.system = system;
            this.Wallet = wallet;
