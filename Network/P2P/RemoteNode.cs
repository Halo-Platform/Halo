...
using Akka.IO;
using Halo.Cryptography;
using Halo.IO;
using Halo.IO.Actors;
using Halo.Ledger;
...
namespace Halo.Network.P2P
{
    public class RemoteNode : Connection
    {
        ...
        private readonly SandSystem system;
        ...
        public RemoteNode(SandSystem system, object connection, IPEndPoint remote, IPEndPoint local)
        ...
        internal static Props Props(SandSystem system, object connection, IPEndPoint remote, IPEndPoint local)
        {
